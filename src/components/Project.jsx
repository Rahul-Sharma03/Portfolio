  ...
  return (
    <div className="project w-full h-auto p-10">
      ...
      <div className="works w-full h-auto  mt-4 p-10 flex md:flex-row flex-col flex-wrap justify-between">
        ...
        <Cards name={"todo list"} desc={"(A daily task holder)"} href={"https://todo-velvet-echo.netlify.app"}/>
        <Cards name={"Quiz"} desc={"(Brain Teaser Quest)"} href={"https://quiz-app-bouncing.netlify.app"} />
        <Cards name={"portfolio"} desc={"(My Own Portfolio)"} href={"https://rahul-a-sharma-portfolio.netlify.app"}/>
      </div>
    </div>
  );
};
